...
CLIENTES = {
    "Tere": {
        ...
        "gid_variaveis": "import streamlit as st
import pandas as pd
import requests
import urllib.parse
import re
...
# -----------------------------------------------------------------------------
# 3. TRATAMENTO NUMÉRICO E CONVERSÃO
# -----------------------------------------------------------------------------
...
if not df_var_f.empty:
    ...
    st.info("Nenhum lançamento de contas variáveis registrado para o filtro ativo.")",  # GID FIXADO NATIVAMENTE
        "logo_file": "LOGO FINO HOUSE.png"
    },
    "OB": {
        "nome": "Fiño House - Minas Gerais (OB)", 
